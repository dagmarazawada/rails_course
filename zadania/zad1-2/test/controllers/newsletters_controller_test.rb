...
class NewslettersControllerTest < ActionController::TestCase
  ...
  test "should create newsletter" do
    assert_difference('Newsletter.count') do
      post :create, newsletter: { content: @newsletter.content, is_sent: @newsletter.is_sent, receipients: @newsletter.receipients }
    end
  ...
  test "should update newsletter" do
    patch :update, id: @newsletter, newsletter: { content: @newsletter.content, is_sent: @newsletter.is_sent, receipients: @newsletter.receipients }
    assert_redirected_to newsletter_path(assigns(:newsletter))
  end
